    ...
    return (
      <div>
        ...
        <div className="App-Content">
          ...
          <p>作为永远都会写代码的程序猿，2010年开始从事编程的工作，前 <strong>远光-携程-阿里巴巴</strong> 员工，经历了从前端到大前端变革的整个过程，在 <strong>前端，工程化，Hybrid，Weex，Flutter，Node.js，跨平台架构领域</strong> 等方面有着非常丰富的实践和沉淀，于是成为了一名“核常兼备”很“完善”的工程师。</p>
          <p>
