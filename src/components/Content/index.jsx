    ...
    return (
      <div>
        ...
        <div className="App-Content">
          ...
          <p>作为永远都会写代码的程序猿，2010年开始从事编程的工作，前 <strong>远光-携程-阿里巴巴</strong> 员工，经历了从前端到大前端变革的整个过程，在 <strong>前端，工程化，Hybrid，Weex，Flutter，Node.js，Go，跨平台架构领域</strong> 等方面有着非常丰富的实践和沉淀，于是成为了一名“核常兼备”很“完善”的工程师。</p>
          <p>
            <em>I stared to work as a front-end developer from 2010 until now, had ever been employed by <strong>YuanGuang, Citrip and Alibaba Group</strong>. All of the different experience make me grow up in this field, and I also have accumulated so much knowledge and practical skills in not only front-end development, but also <strong>Engineering, Hybrid, Weex, Flutter, Node.js as well as Go </strong>. Now I could say that I have already become a “well-appointed” engineer.</em>
          </p>
          <p>
            <a 
