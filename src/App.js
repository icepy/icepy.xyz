    ...
    return (
      <div className="App">
        ...
        <div className="App-Content">
          ...
          做为永远都会写代码的程序员，2010开始从事编程的工作，前 <strong>远光-携程-阿里巴巴</strong> 员工，经历了从前端到大前端变革的整个过程，在 <strong>工程化, Hybrid, Weex, Flutter, Node.js, 混合架构等领域</strong> 等方面有着非常丰富的经验，于是成为了一个“核常兼备”很“完善”的工程师。
          <p>
