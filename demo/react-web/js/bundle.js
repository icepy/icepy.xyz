...
/***/ function(module, exports, __webpack_require__) {
	...
	var _animation = __webpack_require__(223);
	...
	var InboxList = _react2.default.createClass({
		...
		render: function render() {
			...
			var inboxInfo = this.props.inboxInfo.map(function (info, i) {
				return _react2.default.createElement(
					'li',
					{ key: "_" + info, onClick: _this.handleClick.bind(_this, i) },
					info
				);
			});
			var style = {
	...
	var Inbox = _react2.default.createClass({
		...
		render: function render() {
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					'button',
					{ style: buttonStyle, type: 'button', className: 'am-btn am-btn-danger', onClick: this.removeOnceList },
					'remove'
				),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var DefaultAnimation = _react2.default.createClass({
		displayName: 'DefaultAnimation',
		getInitialState: function getInitialState() {
			return {
				items: [{ "id": 0, "name": "icepy" }, { "id": 1, "name": "wen" }, { "id": 2, "name": "xiang" }]
			};
		},
		...
		render: function render() {
			...
			var items = this.state.items.map(function (item, i) {
				return _react2.default.createElement(
					'li',
					{ key: item.id, className: item.isRemoving ? 'removing-item' : '' },
					item.name,
					_react2.default.createElement(
						'button',
						{ style: removeStyle, type: 'button', className: 'am-btn am-btn-danger', onClick: _this.handleRemove.bind(_this, item) },
						'remove'
					)
				);
			});
